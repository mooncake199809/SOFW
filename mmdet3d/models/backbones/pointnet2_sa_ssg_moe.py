...
class PointNet2SASSG_MOE(BasePointNet):
    ...
    def __init__(self,
                 ...
                 sa_channels=((64, 64, 128), (128, 128, 256), (128, 128, 256),
                              (128, 128, 256)),
                 inverted_sa_channels = ((64, 128), (128, 256), (128, 256), 
                                         (128, 256)),
        ...
        for sa_index in range(self.num_sa):
            ...
            cur_sa_mlps_inverted = list(inverted_sa_channels[sa_index])
            cur_sa_mlps_inverted = [cur_sa_mlps[-1]] + cur_sa_mlps_inverted
            sa_out_channel = cur_sa_mlps_inverted[-1]
            ...
            self.SA_modules.append(
                build_sa_module(
                    ...
                    mlp_channels_inverted=cur_sa_mlps_inverted,
                    fps_mod = fps_mod,
                    conv_cfg=conv_cfg,
                    norm_cfg=norm_cfg,
                    cfg=sa_cfg))
    ...
    # # Modified by DK
    # def train(self, mode):
    #     super(PointNet2SASSG_MOE, self).train(mode)
