...
class PointNet2HeadCLS(Base3DDecodeHead):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(PointNet2HeadCLS, self).__init__(**kwargs)
    ...
    def forward(self, feat_dict):
        ...
        B,C,N = fp_feature.shape
        fp_feature = F.max_pool1d(fp_feature, N, 1)

        output = self.pre_seg_conv(fp_feature)
        output = self.cls_seg(output)[:,:,0]               # [B 40 1]
        return output
